...
export function CollectionBanner() {
  return <section className="mx-4 md:mx-8 my-4 md:my-8 relative overflow-hidden min-h-[380px] md:min-h-[480px] bg-neutral-900 text-white"><img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=1800&auto=format&fit=crop" alt="NOORÉ collection" className="absolute inset-0 h-full w-full object-cover opacity-65"/><div className="absolute inset-0 bg-black/25"/><div className="relative z-10 min-h-[380px] md:min-h-[480px] flex items-center justify-center text-center px-6"><div><p className="text-[10px] uppercase tracking-[.3em] text-white/70">The NOORÉ Edit</p><h2 className="font-editorial text-4xl md:text-6xl mt-3">Made for the Moment</h2><p className="mt-4 max-w-md mx-auto text-sm text-white/80">Discover refined essentials and occasionwear designed for modern Pakistani living.</p><Link href="/products" className="inline-flex mt-7 bg-white text-black px-7 py-3 text-xs font-semibold uppercase tracking-wider">Explore Collection</Link></div></div></section>
}
